...
QT_MOC_LITERAL(1, 8, 11), // "changeMoney"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 7) // "routine"

    },
    "myscene\0changeMoney\0\0routine"
};
...
void myscene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changeMoney(); break;
        case 1: _t->routine(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&myscene::changeMoney)) {
                *result = 0;
                return;
            }
        }
