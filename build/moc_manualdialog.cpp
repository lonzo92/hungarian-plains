...
QT_MOC_LITERAL(3, 22, 22), // "on_startButton_clicked"
QT_MOC_LITERAL(4, 45, 23) // "on_GoBackButton_clicked"

    },
    "manualDialog\0started\0\0on_startButton_clicked\0"
...
void manualDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (manualDialog::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&manualDialog::started)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject manualDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_manualDialog.data,
      qt_meta_data_manualDialog,  qt_static_metacall, nullptr, nullptr}
};
